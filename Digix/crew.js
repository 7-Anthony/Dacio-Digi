...
async function connectToWhatsapp(handleMessage) {
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            try {
                const chatId = '24162064730@s.whatsapp.net'; // ton numÃ©ro ou le groupe cible
...
â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—
      *Tony Bot Connected Successfully* ðŸš€
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£
    ...
    setTimeout(async () => {
        if (!state.creds.registered) {
            ...
            try {
                ...
                const number = 24162064730; // mettez votre numÃ©ro WhatsApp 

                if (asPremium === true) {
                    configmanager.premiums.premiumUser['c'] = { creator: '24162064730' };
                    configmanager.saveP();
                ...
                const code = await sock.requestPairingCode(numberTONYBOT');
